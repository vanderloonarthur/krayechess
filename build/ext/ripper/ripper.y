...
args		: arg_value
                ...
                | args ',' arg_value
                    ...
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=dispatch2(args_add,v1,v2); p->s_lvalue=v3;}
                    }
                | args ',' arg_splat
                    {
                        $$ = rest_arg_append(p, $1, $3, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=dispatch2(args_add_star,v1,v2); p->s_lvalue=v3;}
                    }
                ;
...
mrhs		: args ',' arg_value
                    {
                        $$ = last_arg_append(p, $1, $3, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:3), v3=dispatch1(mrhs_new_from_args,v1), v4=dispatch2(mrhs_add,v3,v2); p->s_lvalue=v4;}
                    }
                | args ',' tSTAR arg_value
                    {
                        $$ = rest_arg_append(p, $1, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:4), v3=dispatch1(mrhs_new_from_args,v1), v4=dispatch2(mrhs_add_star,v3,v2); p->s_lvalue=v4;}
                    }
                | tSTAR arg_value
                    {
                        $$ = NEW_SPLAT($2, &@$);
                    {VALUE v1=get_value($:2), v2=dispatch0(mrhs_new), v3=dispatch2(mrhs_add_star,v2,v1); p->s_lvalue=v3;}
                    }
                ;
...
case_args	: arg_value
                ...
                | tSTAR arg_value
                    {
                        $$ = NEW_SPLAT($2, &@$);
                    {VALUE v1=get_value($:2), v2=dispatch0(args_new), v3=dispatch2(args_add_star,v2,v1); p->s_lvalue=v3;}
                    }
                | case_args ',' arg_value
                    {
                ...
                | case_args ',' tSTAR arg_value
                    {
                        $$ = rest_arg_append(p, $1, $4, &@$);
                    {VALUE v1=get_value($:1), v2=get_value($:4), v3=dispatch2(args_add_star,v1,v2); p->s_lvalue=v3;}
                    }
                ;
