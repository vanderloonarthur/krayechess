...
static const struct {
    ...
    char L200[503]; /* 201..266 */
    char L266[484]; /* 267..350 */
    char L350[302]; /* 351..374 */
} prelude_code3 = {
#line 1 "numeric.rb"
"class Numeric\n"
"\n"
...
static const struct {
    ...
    char L419[460]; /* 420..425 */
    char L425[476]; /* 426..431 */
    char L431[498]; /* 432..437 */
    char L437[445]; /* 438..442 */
    char L442[502]; /* 443..448 */
    char L448[449]; /* 449..453 */
    char L453[483]; /* 454..460 */
    char L460[499]; /* 461..467 */
    char L467[504]; /* 468..478 */
    char L478[471]; /* 479..498 */
    char L498[480]; /* 499..517 */
    char L517[492]; /* 518..538 */
    char L538[454]; /* 539..558 */
    char L558[473]; /* 559..578 */
    char L578[481]; /* 579..598 */
    char L598[481]; /* 599..618 */
    char L618[500]; /* 619..638 */
    char L638[464]; /* 639..658 */
    char L658[490]; /* 659..678 */
    char L678[500]; /* 679..697 */
    char L697[499]; /* 698..717 */
    char L717[446]; /* 718..734 */
    char L734[471]; /* 735..754 */
    char L754[485]; /* 755..771 */
    char L771[430]; /* 772..778 */
    char L778[467]; /* 779..792 */
    char L792[492]; /* 793..803 */
    char L803[463]; /* 804..809 */
    char L809[477]; /* 810..820 */
    char L820[489]; /* 821..827 */
    char L827[493]; /* 828..839 */
    char L839[400]; /* 840..846 */
    char L846[504]; /* 847..859 */
    char L859[508]; /* 860..867 */
    char L867[408]; /* 868..871 */
    char L871[500]; /* 872..879 */
    char L879[457]; /* 880..887 */
    char L887[507]; /* 888..893 */
    char L893[496]; /* 894..909 */
    char L909[456]; /* 910..922 */
    char L922[379]; /* 923..925 */
    char L925[413]; /* 926..933 */
    char L933[461]; /* 934..941 */
    char L941[419]; /* 942..944 */
    char L944[446]; /* 945..952 */
    char L952[419]; /* 953..955 */
    char L955[459]; /* 956..964 */
    char L964[478]; /* 965..970 */
    char L970[442]; /* 971..981 */
    char L981[486]; /* 982..986 */
    char L986[395]; /* 987..994 */
    char L994[429]; /* 995..1002 */
    char L1002[465]; /* 1003..1009 */
    char L1009[448]; /* 1010..1021 */
    char L1021[493]; /* 1022..1025 */
    char L1025[447]; /* 1026..1033 */
    char L1033[458]; /* 1034..1037 */
    char L1037[474]; /* 1038..1045 */
    char L1045[432]; /* 1046..1048 */
    char L1048[423]; /* 1049..1051 */
    char L1051[474]; /* 1052..1054 */
    char L1054[438]; /* 1055..1057 */
    char L1057[438]; /* 1058..1060 */
    char L1060[408]; /* 1061..1063 */
    char L1063[435]; /* 1064..1067 */
    char L1067[453]; /* 1068..1074 */
    char L1074[496]; /* 1075..1082 */
    char L1082[497]; /* 1083..1089 */
    char L1089[493]; /* 1090..1098 */
    char L1098[483]; /* 1099..1103 */
    char L1103[420]; /* 1104..1106 */
    char L1106[426]; /* 1107..1109 */
    char L1109[498]; /* 1110..1113 */
    char L1113[443]; /* 1114..1116 */
    char L1116[490]; /* 1117..1120 */
    char L1120[472]; /* 1121..1124 */
    char L1124[382]; /* 1125..1127 */
    char L1127[437]; /* 1128..1130 */
    char L1130[427]; /* 1131..1133 */
    char L1133[437]; /* 1134..1137 */
    char L1137[430]; /* 1138..1142 */
    char L1142[441]; /* 1143..1145 */
    char L1145[424]; /* 1146..1153 */
    char L1153[382]; /* 1154..1156 */
    char L1156[452]; /* 1157..1164 */
    char L1164[398]; /* 1165..1167 */
    char L1167[490]; /* 1168..1175 */
    char L1175[446]; /* 1176..1180 */
    char L1180[378]; /* 1181..1185 */
    char L1185[421]; /* 1186..1190 */
    char L1190[473]; /* 1191..1206 */
    char L1206[484]; /* 1207..1215 */
    char L1215[468]; /* 1216..1223 */
    char L1223[474]; /* 1224..1230 */
    char L1230[481]; /* 1231..1239 */
    char L1239[472]; /* 1240..1248 */
    char L1248[452]; /* 1249..1256 */
    char L1256[494]; /* 1257..1260 */
    char L1260[418]; /* 1261..1268 */
    char L1268[429]; /* 1269..1276 */
    char L1276[467]; /* 1277..1292 */
    char L1292[508]; /* 1293..1297 */
    char L1297[420]; /* 1298..1301 */
    char L1301[418]; /* 1302..1309 */
    char L1309[476]; /* 1310..1312 */
    char L1312[358]; /* 1313..1314 */
    char L1314[358]; /* 1315..1316 */
    char L1316[350]; /* 1317..1318 */
    char L1318[484]; /* 1319..1321 */
    char L1321[466]; /* 1322..1324 */
    char L1324[484]; /* 1325..1327 */
    char L1327[434]; /* 1328..1330 */
    char L1330[432]; /* 1331..1333 */
    char L1333[450]; /* 1334..1336 */
    char L1336[502]; /* 1337..1339 */
    char L1339[462]; /* 1340..1342 */
    char L1342[470]; /* 1343..1345 */
    char L1345[486]; /* 1346..1348 */
    char L1348[332]; /* 1349..1350 */
    char L1350[374]; /* 1351..1352 */
    char L1352[492]; /* 1353..1355 */
    char L1355[488]; /* 1356..1358 */
    char L1358[494]; /* 1359..1361 */
    char L1361[344]; /* 1362..1363 */
    char L1363[344]; /* 1364..1365 */
    char L1365[344]; /* 1366..1367 */
    char L1367[358]; /* 1368..1369 */
    char L1369[344]; /* 1370..1371 */
    char L1371[498]; /* 1372..1374 */
    char L1374[484]; /* 1375..1377 */
    char L1377[470]; /* 1378..1380 */
    char L1380[366]; /* 1381..1382 */
    char L1382[386]; /* 1383..1384 */
    char L1384[348]; /* 1385..1386 */
    char L1386[344]; /* 1387..1388 */
    char L1388[358]; /* 1389..1390 */
    char L1390[346]; /* 1391..1392 */
    char L1392[494]; /* 1393..1395 */
    char L1395[468]; /* 1396..1398 */
    char L1398[504]; /* 1399..1401 */
    char L1401[342]; /* 1402..1403 */
    char L1403[352]; /* 1404..1405 */
    char L1405[364]; /* 1406..1407 */
    char L1407[478]; /* 1408..1410 */
    char L1410[488]; /* 1411..1413 */
    char L1413[476]; /* 1414..1416 */
    char L1416[486]; /* 1417..1419 */
    char L1419[464]; /* 1420..1422 */
    char L1422[476]; /* 1423..1425 */
    char L1425[336]; /* 1426..1427 */
    char L1427[364]; /* 1428..1429 */
    char L1429[506]; /* 1430..1432 */
    char L1432[445]; /* 1433..1444 */
    char L1444[493]; /* 1445..1448 */
    char L1448[474]; /* 1449..1460 */
    char L1460[469]; /* 1461..1464 */
    char L1464[503]; /* 1465..1468 */
    char L1468[471]; /* 1469..1472 */
    char L1472[390]; /* 1473..1475 */
    char L1475[387]; /* 1476..1478 */
    char L1478[423]; /* 1479..1481 */
    char L1481[393]; /* 1482..1484 */
    char L1484[394]; /* 1485..1489 */
    char L1489[425]; /* 1490..1494 */
    char L1494[494]; /* 1495..1499 */
    char L1499[499]; /* 1500..1503 */
    char L1503[426]; /* 1504..1506 */
    char L1506[481]; /* 1507..1525 */
    char L1525[505]; /* 1526..1554 */
    char L1554[506]; /* 1555..1586 */
    char L1586[505]; /* 1587..1614 */
    char L1614[507]; /* 1615..1645 */
    char L1645[440]; /* 1646..1671 */
} prelude_code7 = {
#line 1 "rjit_c.rb"
...
static const struct {
    char L0[501]; /* 1..82 */
    char L82[484]; /* 83..163 */
    char L163[432]; /* 164..209 */
    char L209[118]; /* 210..215 */
} prelude_code11 = {
#line 1 "array.rb"
"class Array\n"
"\n"/* call-seq: */
...
"  end\n"
"end\n"
#line 4877 "miniprelude.c"
};

static const char prelude_name12[] = "<internal:kernel>";
static const struct {
    char L0[490]; /* 1..131 */
    char L131[441]; /* 132..185 */
    char L185[467]; /* 186..308 */
    char L308[193]; /* 309..317 */
} prelude_code12 = {
#line 1 "kernel.rb"
"module Kernel\n"
"\n"/*  */
...
"  alias intern to_sym\n"
"end\n"
#line 6128 "miniprelude.c"
};

static const char prelude_name15[] = "<internal:timev>";
static const struct {
    char L0[477]; /* 1..434 */
    char L434[507]; /* 435..452 */
    char L452[78]; /* 453..456 */
} prelude_code15 = {
#line 1 "timev.rb"
...
static const struct {
    ...
    char L152[467]; /* 153..172 */
    char L172[488]; /* 173..192 */
    char L192[474]; /* 193..215 */
    char L215[477]; /* 216..242 */
    char L242[450]; /* 243..268 */
    char L268[423]; /* 269..276 */
    char L276[411]; /* 277..280 */
    char L280[508]; /* 281..298 */
    char L298[465]; /* 299..310 */
    char L310[500]; /* 311..327 */
    char L327[414]; /* 328..331 */
    char L331[442]; /* 332..335 */
    char L335[499]; /* 336..341 */
    char L341[488]; /* 342..346 */
    char L346[434]; /* 347..350 */
    char L350[436]; /* 351..356 */
    char L356[447]; /* 357..361 */
    char L361[498]; /* 362..366 */
    char L366[471]; /* 367..372 */
    char L372[452]; /* 373..378 */
    char L378[472]; /* 379..384 */
    char L384[495]; /* 385..391 */
    char L391[433]; /* 392..397 */
    char L397[432]; /* 398..402 */
    char L402[433]; /* 403..407 */
    char L407[437]; /* 408..416 */
    char L416[508]; /* 417..430 */
    char L430[491]; /* 431..447 */
    char L447[489]; /* 448..457 */
    char L457[477]; /* 458..474 */
    char L474[425]; /* 475..489 */
    char L489[483]; /* 490..503 */
    char L503[320]; /* 504..519 */
} prelude_code20 = {
#line 1 "yjit.rb"
""/* frozen_string_literal: true */
""/* :markup: markdown */
...
rb_builtin_ast_value(const char *feature_name, VALUE *name_str)
{
    ...
    if (!NIL_P(ast_value = PRELUDE_VAST(0, *name_str, 20))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(1, *name_str, 158))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(2, *name_str, 11))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(3, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(4, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(5, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(6, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(7, *name_str, 4))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(8, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(9, *name_str, 50))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(10, *name_str, 4))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(11, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(12, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(13, *name_str, 239))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(14, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(15, *name_str, 256))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(16, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(17, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(18, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(19, *name_str, 1))) return ast_value;
    if (!NIL_P(ast_value = PRELUDE_VAST(20, *name_str, 10))) return ast_value;
    return ast_value;
}
...
pm_builtin_ast_value(pm_parse_result_t *result, const char *feature_name, VALUE *name_str)
{
    ...
    if (
        (sizeof(prelude_name0) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name0 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(0);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(0), 20);
        return true;
    }
    if (
        (sizeof(prelude_name1) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name1 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(1);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(1), 158);
        return true;
    }
    if (
        (sizeof(prelude_name2) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name2 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(2);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(2), 11);
        return true;
    }
    if (
        (sizeof(prelude_name3) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name3 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(3);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(3), 1);
        return true;
    }
    if (
        (sizeof(prelude_name4) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name4 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(4);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(4), 1);
        return true;
    }
    if (
        (sizeof(prelude_name5) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name5 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(5);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(5), 1);
        return true;
    }
    if (
        (sizeof(prelude_name6) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name6 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(6);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(6), 1);
        return true;
    }
    if (
        (sizeof(prelude_name7) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name7 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(7);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(7), 4);
        return true;
    }
    if (
        (sizeof(prelude_name8) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name8 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(8);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(8), 1);
        return true;
    }
    if (
        (sizeof(prelude_name9) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name9 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(9);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(9), 50);
        return true;
    }
    if (
        (sizeof(prelude_name10) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name10 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(10);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(10), 4);
        return true;
    }
    if (
        (sizeof(prelude_name11) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name11 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(11);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(11), 1);
        return true;
    }
    if (
        (sizeof(prelude_name12) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name12 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(12);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(12), 1);
        return true;
    }
    if (
        (sizeof(prelude_name13) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name13 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(13);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(13), 239);
        return true;
    }
    if (
        (sizeof(prelude_name14) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name14 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(14);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(14), 1);
        return true;
    }
    if (
        (sizeof(prelude_name15) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name15 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(15);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(15), 256);
        return true;
    }
    if (
        (sizeof(prelude_name16) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name16 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(16);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(16), 1);
        return true;
    }
    if (
        (sizeof(prelude_name17) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name17 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(17);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(17), 1);
        return true;
    }
    if (
        (sizeof(prelude_name18) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name18 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(18);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(18), 1);
        return true;
    }
    if (
        (sizeof(prelude_name19) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name19 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(19);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(19), 1);
        return true;
    }
    if (
        (sizeof(prelude_name20) - prefix_len - 2 == namelen) &&
        (strncmp(prelude_name20 + prefix_len, feature_name, namelen) == 0)
    ) {
        *name_str = PRELUDE_NAME(20);
        pm_prelude_load(result, *name_str, PRELUDE_CODE(20), 10);
        return true;
    }
