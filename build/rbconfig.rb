...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.4.0+0/arm64-darwin23")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/mac/.rubies/ruby-master")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/mac/.rubies/ruby-master' 'LDFLAGS=-L/opt/local/' 'CPPFLAGS=-I/usr/local/opt/openssl/include'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/mac/.rubies/ruby-master"
  ...
  CONFIG["DLDFLAGS"] = "-L/opt/local/ -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/usr/local/opt/openssl/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/opt/local/ -fstack-protector-strong"
  ...
  CONFIG["build"] = "aarch64-apple-darwin23.5.0"
