...
encsrcdir = ../enc
topdir = .
prefix = /Users/mac/ruby/build
exec_prefix = /Users/mac/ruby/build
libdir = /Users/mac/ruby/build
...
OUTFLAG = -o $(empty)
COUTFLAG = -o $(empty)
CFLAGS = $(CCDLFLAGS) $(cflags) -pipe -arch arm64
...
DEFS = 
CPPFLAGS = -I/usr/local/opt/openssl/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT   -DONIG_ENC_REGISTER=rb_enc_register
LDFLAGS = -L. -L/opt/local/ -fstack-protector-strong
LDSHARED = clang -dynamic -bundle
POSTLINK = dsymutil $@ 2>/dev/null; { test -z '$(RUBY_CODESIGN)' || codesign -s '$(RUBY_CODESIGN)' $@; }
ldflags  = $(LDFLAGS)
dldflags = -L/opt/local/ -Wl,-undefined,dynamic_lookup
