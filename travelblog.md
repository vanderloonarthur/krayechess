...
<body>
  ...
  <script>
    ...
    var url = "http://0.0.0.0:8000/receive_feedback/"; // Adjust the URL as needed
...
function sendPostRequest(feedback, reaction, additionalComments) {
    var xhr = new XMLHttpRequest();
    var url = "http://0.0.0.0:8000/receive_feedback/";  // URL to the Django view handling feedback submission
    xhr.open("POST", url, true);
